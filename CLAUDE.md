...
data/       starts empty on purpose — the demo generates the dataset live:
            one prompt has the agent write tools/fetch_genai_papers.py
            (fetch 1,000 GenAI papers, clean them up on the way in, and
            print a report of what it did) and run it
